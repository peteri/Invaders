...
{
    public class AlienShotPlunger : AlienShot
    {
        private static byte[] PlungerShotSprite = { 0x04, 0xfc, 0x4, 0x10, 0xfc, 0x10, 0x20, 0xfc, 0x20, 0x80, 0xfc, 0x80 };
        private static byte[] shotColumns = { 0x01, 0x07, 0x01, 0x01, 0x01, 0x04, 0x0B, 0x01, 0x06, 0x03, 0x01, 0x01, 0x0B, 0x09, 0x02, 0x08 };
        private int currentShotColumn;
        
        public AlienShotPlunger(MainWindow mainWindow, GameData gameData) : base(mainWindow, gameData, PlungerShotSprite)
        {
            ResetShotData();
        }
