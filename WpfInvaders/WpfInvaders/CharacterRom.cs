...
namespace WpfInvaders
{
    public class CharacterRom
    {
        private static readonly byte[][] _characterSprites = new byte[][]
        {
            ...
            new byte[] {0x00,0x7C,0x02,0x01,0x02,0x7C,0x00,0x00 }, // V = 0x4a
            new byte[] {0x00,0x60,0x10,0x0F,0x10,0x60,0x00,0x00 }, // Y = 0x4b
            new byte[] {0x00,0x22,0x14,0x7F,0x14,0x22,0x00,0x00 }, // * = 0x4c
            new byte[] {0x00,0x08,0x08,0x08,0x08,0x08,0x00,0x00 }, // - = 0x4d
            new byte[] {0x00,0x08,0x14,0x22,0x41,0x00,0x00,0x00 }, // < = 0x4e
            new byte[] {0x00,0x14,0x14,0x14,0x14,0x14,0x00,0x00 }, // = = 0x4f
        ...
        static CharacterRom()
        {
            ...
            foreach (char c in "0123456789ABCDEFHILMNOPRSTVY*-<=>?@_")
                Map[c] = (byte)(i++);
        }
