...
namespace WpfInvaders
{
    public class CharacterRom
    {
        ...
        static CharacterRom()
        {
            ...
            GeneratePlayerShifted(0x5b, Player, PlayerExp1, PlayerExp2, 0, 16);
            GeneratePlayerShifted(0x65, Player, PlayerExp1, PlayerExp2, 1, 24);
            GeneratePlayerShifted(0x6e, Player, PlayerExp1, PlayerExp2, 2, 24);
            GeneratePlayerShifted(0x77, Player, PlayerExp1, PlayerExp2, 3, 24);
